...
const pages = [
    ({style}) => <animated.div style={{...style, gridRow: '2 / auto', gridColumn: '2/5'}}><h1 style={{color: '#e0e1dd'}}>About Cole Songer</h1></animated.div>,
    ({style}) => <animated.div style={{...style, gridRow: '2 / auto', gridColumn: '2/5'}}><h1 style={{color: '#e0e1dd'}}>About AC Bland</h1></animated.div>,
    ({style}) => <animated.div style={{...style,  gridRow: '2 / auto', gridColumn: '2 / 5'}}><h1 style={{color: '#e0e1dd'}}>About Peanut Songer</h1></animated.div>,
    ...
    return (
        <div className='about-me' style={{display: 'grid', gridGap: '5px', overflowY: 'scroll', gridTemplateColumns: 'repeat(5, minmax(17vw, .5fr))', gridTemplateRows: 'repeat(3, 30vh)'}}>
            ...
            <svg width="40" height="50" viewBox="0 0 42 53">
              <path d="M0,0 l40,25 l-40,25" fill="none" stroke="black" strokeWidth="3" />
            </svg>
            </div>
            </div>
    )
